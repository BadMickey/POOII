...
public class VinhoTinto {
	...
	public String Tipo = "VinhoTinto";
	public String DataFabricacao;
	public String TamanhoGarrafa;
	public boolean Industrial;
	public boolean Artesanal;
	
	public VinhoTinto(String TeorAlcoolico, String Tipo, String DataFabricacao, String TamanhoGarrafa, boolean Industrial, boolean Artesanal) {
