...
public class FabricaVinhosIndustrial implements FabricaVinhos{
    ...
    public VinhoBranco fabricarVinhoBranco() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'fabricarVinhoBranco'");
    }

    @Override
    public VinhoTinto fabricarVinhoTinto() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'fabricarVinhoTinto'");
    }
